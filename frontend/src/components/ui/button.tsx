      ...
      <Comp
        className={cn(
          "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]",
          {
            ...
            "border-2 border-input bg-background hover:bg-accent hover:text-accent-foreground hover:border-primary/50": variant === 'outline',
            "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm": variant === 'secondary',
            "hover:bg-accent hover:text-accent-foreground": variant === 'ghost',
            "text-primary underline-offset-4 hover:underline focus-visible:ring-0": variant === 'link',
          },
          {
            "h-10 px-4 py-2 min-h-[44px]": size === 'default',
            "h-9 rounded-md px-3 min-h-[36px]": size === 'sm',
            "h-12 rounded-md px-8 min-h-[48px] text-base": size === 'lg',
