...
export default function HomePage() {
  return (
    <MainLayout>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 lg:py-32">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 bg-blue-50 border border-blue-100 rounded-full text-sm font-medium text-blue-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button asChild size="lg" className="text-base sm:text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-200">
                <Link href="/auth/login">
                  <SparklesIcon className="w-5 h-5 mr-2" />
                  Get Started
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="text-base sm:text-lg px-8 py-6 border-2 hover:bg-gray-50 transition-all duration-200">
                <Link href="/blog">
      ...
      {/* Features Section - Enhanced Academic Layout */}
      ...
      {/* Benefits Section - Professional Stats Layout */}
      ...
      <div className="py-20 md:py-24 lg:py-28 bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button asChild size="lg" variant="secondary" className="text-base sm:text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-all duration-200">
              <Link href="/auth/login">
                <UsersIcon className="w-5 h-5 mr-2" />
                Start Free Trial
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="text-base sm:text-lg px-8 py-6 text-white border-2 border-white hover:bg-white hover:text-blue-600 transition-all duration-200">
              <Link href="/contact">
                Contact Sales
              </Link>
            </Button>
